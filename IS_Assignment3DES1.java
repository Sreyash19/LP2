...
String textFile = "I://Artificial Intelligent AI//LP- II Practicals//IS//My IS Experiment//IS Experiment No-3/DemoData.txt";  
//path of the encrypted file that we get as output  
String encryptedData = "I://Artificial Intelligent AI//LP- II Practicals//IS//My IS Experiment//IS Experiment No-3/encrypteddata.txt";  
//path of the decrypted file that we get as output  
String decryptedData = "I://Artificial Intelligent AI//LP- II Practicals//IS//My IS Experiment//IS Experiment No-3/decrypteddata.txt";  
try   
{  
